...
double FL_Zcord[cordArray] = {-169.71, -149.71, -169.71};

double FR_Xcord[cordArray] = {0, 0, 0};
double FR_Zcord[cordArray] = {-149.71, -169.71, -149.71};

double BR_Xcord[cordArray] = {0, 0, 0};
double BR_Zcord[cordArray] = {-169.71, -149.71, -169.71};

double BL_Xcord[cordArray] = {0, 0, 0};
double BL_Zcord[cordArray] = {-149.71, -169.71, -149.71};
