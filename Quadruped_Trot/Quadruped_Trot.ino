...
const int cordArray = 5;

// Given coordinates are in the unit of mm
double FL_Xcord[cordArray] = {-25, 25, 25, 0, -25};
double FL_Zcord[cordArray] = {-169.71, -149.71, -169.71, -169.71, -169.71};

double FR_Xcord[cordArray] = {25, 0, -25, 25, 25};
double FR_Zcord[cordArray] = {-169.71, -169.71, -169.71, -149.71, -169.71};

double BR_Xcord[cordArray] = {-25, 25, 25, 0, -25};
double BR_Zcord[cordArray] = {-169.71, -149.71, -169.71, -169.71, -169.71};

double BL_Xcord[cordArray] = {25, 0, -25, 25, 25};
double BL_Zcord[cordArray] = {-169.71, -169.71, -169.71, -149.71, -169.71};
