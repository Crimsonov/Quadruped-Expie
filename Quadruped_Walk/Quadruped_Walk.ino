...
const int cordArray = 9;

// Given coordinates are in the unit of mm
double FL_Xcord[cordArray] = {-25, 0, 25, 16.67, 8.33, 0, -8.33, -16.67, -25};
double FL_Zcord[cordArray] = {-169.71, -144.71, -169.71, -169.71, -169.71, -169.71, -169.71, -169.71, -169.71};

double FR_Xcord[cordArray] = {8.33, 0, -8.33, -16.67, -25, 0, 25, 16.67, 8.33};
double FR_Zcord[cordArray] = {-169.71, -169.71, -169.71, -169.71, -169.71, -144.71, -169.71, -169.71, -169.71};

double BR_Xcord[cordArray] = {-8.33, -16.67, -25, 0, 25, 16.67, 8.33, 0, -8.33};
double BR_Zcord[cordArray] = {-169.71, -169.71, -169.71, -144.71, -169.71, -169.71, -169.71, -169.71, -169.71};

double BL_Xcord[cordArray] = {25, 16.67, 8.33, 0, -8.33, -16.67, -25, 0, 25};
double BL_Zcord[cordArray] = {-169.71, -169.71, -169.71, -169.71, -169.71, -169.71, -169.71, -144.71, -169.71};
